...
def third_req_plate(plate):
    ...
    # if the number is in the first character of the plate or it is a 0.
        ...
        # index to the end.
        numbers_plate = plate[0: len(plate)-index]
...
"""
    ...
    # met, we already have the non-valid check, so it is not need to implement
    # an "else" clause.
